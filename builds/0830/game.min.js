...
player = {
    ...
    draw: function(){
        actx = gamectx;
        actx.drawImage(sprites, this.x-d[6], this.y-viewY);
    },
...
step = dt => {
  ...
  player.update();
  if(player.x - d[6] + deadzoneX > viewW){
    d[6] = player.x - (viewW - deadzoneX)
  }
  else if(player.x - deadzoneX < d[6]){
    d[6] = player.x - deadzoneX
  }
...
draw = dt => {
  ...
  actx.drawImage(bg.c, d[6], viewY,640,360,0,0,640,360);
